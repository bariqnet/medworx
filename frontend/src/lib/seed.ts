...
async function seed() {
  ...
  const rooms = await db.collection('meetingrooms').insertMany([
    ...
    },
    {
      ...
      priceType: 'daily',
      image: '/images/rooms/conference-hall.jpg',
      isActive: true,
      createdAt: new Date(),
      updatedAt: new Date(),
    },
    ...
    },
    {
      ...
      pricePerHour: 30000,
      image: '/images/rooms/interview-room.jpg',
      isActive: true,
      createdAt: new Date(),
      updatedAt: new Date(),
    },
  ]);
  console.log('✓ 7 meeting rooms created');
